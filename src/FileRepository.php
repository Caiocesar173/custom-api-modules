...
namespace Caiocesar173\Modules;
...
use Caiocesar173\Modules\Exceptions\InvalidAssetPath;
use Caiocesar173\Modules\Exceptions\ModuleNotFoundException;
use Caiocesar173\Modules\Process\Installer;
use Caiocesar173\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Caiocesar173\Modules\Module
     */
     ...
     * @return string
     * @throws \Caiocesar173\Modules\Exceptions\ModuleNotFoundException
     */
